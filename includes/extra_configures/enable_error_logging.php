 ...
 */
//-BOF-debug_backtrace-lat9 *** 1 of 2 ***
...
//-EOF-debug_backtrace-lat9 *** 1 of 2 ***
...
//-BOF-debug_backtrace-lat9 *** 2 of 2 ***
    set_error_handler ('zen_error_handler', $errors_to_log);
//-EOF-debug_backtrace-lat9 *** 2 of 2 ***
